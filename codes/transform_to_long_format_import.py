"""
Transform Commodity Import Data from Wide Format to Long Format

This script processes monthly commodity import Excel files and transforms them
...
def process_monthly_file(filepath, hscode, commodity_name, data_type="Import"):
    """
...
def main():
    ...
    print("="*80)
    print("COMMODITY IMPORT DATA TRANSFORMATION")
    ...
    if all_transformed_data:
        ...
        consolidated_file = os.path.join(OUTPUT_DIR, "all_import_data.xlsx")
